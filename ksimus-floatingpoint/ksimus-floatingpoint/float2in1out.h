...
#ifndef FLOAT2IN1OUT_H
#define FLOAT2IN1OUT_H
...
class Float2In1Out : public Float1Out
{
public: 
// ~Float2In1Out();
	...
	/** Returns the first input connector.
	  */
	ConnectorFloatIn * getInputA() const { return m_inputA; };
	/** Returns the second input connector.
	  */
	ConnectorFloatIn * getInputB() const { return m_inputB; };

	
protected:
	Float2In1Out(CompContainer * container, const ComponentInfo * ci);
...
public:
//	~Float2In1OutView();
	Float2In1OutView(Float2In1Out * comp, eViewType viewType, const QString & text, const char * name);
...
/** The property widget for @ref Float2In1Out components.
  *
...
class Float2In1OutPropertyGeneralWidget : public Float1OutPropertyGeneralWidget
{
public:
	Float2In1OutPropertyGeneralWidget(Float2In1Out * comp, QWidget *parent=0, const char *name=0)
